document.addEventListener('DOMContentLoaded', () => {
  ...
  const presetChips = document.querySelectorAll('.cert-chip');
  const exportCanvas = document.getElementById('exportCanvas');
  if (!recipientInput || !exportCanvas) return; // guard: not embedded on this page
  ...
  function downloadCertificatePNG() {
    ...
    btnDownload.innerHTML = `
      <svg class="cert-spinner" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3">
